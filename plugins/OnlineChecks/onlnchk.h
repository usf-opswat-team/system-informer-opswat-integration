...
#define SETTING_NAME_METADEFENDER_SCAN_ENABLED (PLUGIN_NAME L".EnableMetaDefenderScanning")
#define SETTING_NAME_METADEFENDER_API_KEY (PLUGIN_NAME L".MetaDefenderApiKey")
...
#define UM_EXISTS_META (WM_APP + 6)
...
typedef struct _PROCESS_EXTENSION
{
    ...
    union
    {
        ...
        struct
        {
            ...
            BOOLEAN MDCResultValid : 1;
            BOOLEAN ServiceValid : 1;
            BOOLEAN Spare : 4; //Spare bits unused
        };
    };
...
typedef struct _MDC_FILE_HASH_ENTRY
{
    union
    {
        BOOLEAN Flags;
    ...
    PPH_BYTES FileHashAnsi;
    PPH_BYTES CreationTime;
} MDC_FILE_HASH_ENTRY, * PMDC_FILE_HASH_ENTRY;
...
#define ENABLE_SERVICE_METADEFENDER 130
#define MENUITEM_METADEFENDER_UPLOAD 132
#define MENUITEM_METADEFENDER_UPLOAD_SERVICE 133
#define MENUITEM_METADEFENDER_UPLOAD_WEB 134
#define MENUITEM_METADEFENDER_UPLOAD_WEB_SERVICE 135
...
typedef enum _NETWORK_COLUMN_ID
{
    ...
    COLUMN_ID_METADEFENDER_PROCESS = 4,
    COLUMN_ID_METADEFENDER_MODULE = 5,
    COLUMN_ID_METADEFENDER_SERVICE = 6
} NETWORK_COLUMN_ID;
...
typedef struct _MDC_API_RESULT
{
    INT64 Positives;
    INT64 Total;
    PPH_STRING FileHash;
} MDC_API_RESULT, * PMDC_API_RESULT;
